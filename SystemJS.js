...
function registerFormCheck(){
    var error="";
    var username = $("#usernameRegisterID").val();
    var firstname = $("#firstnameID").val();
    var lastname = $("#lastnameID").val();
    var password = $("#passwordRegisterID").val();
    ...
    if(flag==false){
        error+="password should be letters and numbers only\n";
    }
    if(password.length<8){
        error+="password should be atleast 8 letters\n";
    }
    var flag2=true
